...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2017 at 07:01 AM
...
--
ALTER TABLE `usergroups`
  MODIFY `ID_UG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `activities`
  ADD CONSTRAINT `activities_ibfk_1` FOREIGN KEY (`ID_AT`) REFERENCES `acttypes` (`ID_AT`),
...
--
ALTER TABLE `enrollments`
  ADD CONSTRAINT `enrollments_ibfk_1` FOREIGN KEY (`ID_U`) REFERENCES `users` (`ID_U`),
  ADD CONSTRAINT `enrollments_ibfk_2` FOREIGN KEY (`ID_C`) REFERENCES `courses` (`ID_C`);
